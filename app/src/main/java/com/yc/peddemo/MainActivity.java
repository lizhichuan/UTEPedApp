...
//				mySQLOperate.isDeleteRefreshTable();//2.5.2版本删除
			...
			case GlobalVariable.DOWNLOAD_IMG_FAIL_MSG:
				Toast.makeText(MainActivity.this, R.string.download_fail, 1)
						.show();
			...
			case OFFLINE_SKIP_SYNC_OK_MSG:
				...
				break;
			case test_mag1:
				Toast.makeText(MainActivity.this,"表示按键1短按下，用来做切换屏,表示切换了手环屏幕", 0)//
						.show();
				show_result.setText("表示按键1短按下，用来做切换屏,表示切换了手环屏幕");
				break;
			case test_mag2:
				Toast.makeText(MainActivity.this,"表示按键3短按下，用来做一键SOS", 0)
				.show();
				show_result.setText("表示按键3短按下，用来做一键SOS");
				break;
			case OFFLINE_STEP_SYNC_OK_MSG:
				Toast.makeText(MainActivity.this,"计步数据同步成功", 0)
				.show();
